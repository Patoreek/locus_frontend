          ...
          <div className={classes.post}>
            ...
            <div className={classes.post__content}>
              <p className={classes.content}>
                {" "}
                The Latest news will appear here regarding updates and
                improvements for Locus. Currently at version 1.0 and has
                currently basic functionalities. This includes able to make an
                account and add, edit and contribute to distributing dive site
                information and locations. Basic profiles are available and
                basic image upload is available. More improvements are planned
                such as forum and event features for individual dive sites.
              </p>
            </div>
          </div>
        </div>
