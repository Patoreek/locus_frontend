    ...
    <div className={classes.tos}>
      ...
      <div className={classes.tos__intro}>
        ...
        <p className={classes.paragraph}>
          ...
          the Services and the Site. YOU AGREE THAT BY USING THE SITE AND THE
          SERVICES YOU REPRESENT THAT YOU ARE AT LEAST 18 YEARS OLD AND THAT YOU
      ...
      <div className={classes.tos__restrictions}>
        ...
        <p className={classes.paragraph}>
          ...
          under any circumstances: use the service for any unlawful purpose,
          users are responsible to ensure they follow the legal guidelines set
          forth in their respective states and/or counties attempt to, or
          harass, abuse or harm another person or group; use another user’s
          account without permission; interfere or attempt to interfere with the
          ...
          or network infrastructure; bypass any robot exclusion headers or other
          measures we take to restrict access to the Service or use any
          software, technology, or device to scrape, spider, or crawl the
          Service or harvest or manipulate data; or publish or link to malicious
      ...
      <div className={classes.tos__conduct}>
        ...
        <p className={classes.paragraph}>
          ...
          Content, in this case this is the information posted on the user
          profile and any messaging activity. You are solely responsible for
          your account and the activity that occurs while signed in to or while
          using your account You will not post information that is malicious,
          false or inaccurate Users are personally responsible for any further
          interactions or correspondence that occurs as a result of using the
          service You understand and agree that any liability, loss or damage
          that occurs as a result of the use of any User Content that you make
          ...
          pre-screen or monitor all User Content
        </p>
      </div>
      <hr />
      <div className={classes.tos__disclaimer}>
        ...
        <p className={classes.paragraph}>
          ...
          relied upon. Such authors are solely responsible for such content. The
          Company does not guarantee the accuracy, completeness, or usefulness
          of any information on the Service and neither does the Company adopt
          nor endorse, nor is the Company responsible for, the accuracy or
          reliability of any opinion, advice, or statement made by parties other
          than the Company. The Company takes no responsibility and assumes no
          liability for any User Content that you or any other user or third
          party posts or sends over the Service. Under no circumstances will the
          Company be responsible for any loss or damage resulting from anyone’s
          reliance on information or other content posted on the Service, or
          transmitted to users. Though the Company strives to enforce these
          Terms of Use, you may be exposed to User Content that is inaccurate or
          objectionable. The Company reserves the right, but has no obligation,
          to monitor the materials posted in the public areas of the service or
          to limit or deny a user’s access to the Service or take other
          appropriate action if a user violates these Terms of Use or engages in
          any activity that violates the rights of any person or entity or which
          we deem unlawful, offensive, abusive, or harmful The Company shall
      ...
      <div className={classes.tos__copyright}>
        ...
        <p className={classes.paragraph}>
          ...
          Act, the Company has adopted and implemented a policy that provides
          for the termination in appropriate circumstances of users of the
          Service who are repeat infringers. The Company may terminate access
          for participants or users who are found repeatedly to provide or post
        </p>
      </div>
      <hr />
      ...
      <div className={classes.tos__intelprop}>
        ...
        <p className={classes.paragraph}>
          ...
          on the Service may be trademarks of their respective owners. We
          reserve all rights that are not expressly granted to you under this
          Agreement.
        </p>
      </div>
      <hr />
      ...
      <div className={classes.tos__email}>
        ...
        <p className={classes.paragraph}>
          ...
          will not constitute legal notice to the Company or any of its
      ...
      <div className={classes.tos__comms}>
        ...
        <p className={classes.paragraph}>
          We will not send any unsolicited or thirty party communications to
          your email. For contractual purposes, you (a) consent to receive
      ...
      <div className={classes.tos__warranties}>
        <h3 className={classes.header}>
          User warranties, representations, and acknowledgements
        </h3>
        <p className={classes.paragraph}>
      ...
      <div className={classes.tos__limitations}>
        <h3 className={classes.header}>
          Limitation of damages, release and indemnification
        </h3>
        ...
        <p className={classes.paragraph}>
          ...
          TO USE THE SITE OR THE SERVICES; (C) THE SITE OR THE SERVICES
          GENERALLY OR THE SOFTWARE OR SYSTEMS THAT MAKE THEM AVAILABLE; (D) ANY
          OTHER INTERACTIONS WITH THE COMPANY OR ANY OTHER USER OF THE SITE OR
          THE SERVICES, OR (E) THE ACTS OF ANY OTHER USER OF THE SITE OR THE
          ...
          LIABILITY, SO THIS PROVISION MAY NOT APPLY TO YOU. If you have a
          dispute with one or more users, you release us (and our officers,
          directors, agents, subsidiaries, joint ventures and employees) from
          liability for claims, demands and damages (actual and consequential)
          ...
          debtor.” You agree to fully indemnify, hold harmless and defend
          (collectively “indemnify” and “indemnification”) the Company and its
          directors, officers, employees, agents, stockholders and Affiliates
          (collectively “Indemnified Parties”) from and against all claims,
          demands, actions, suits, damages, liabilities, losses, settlements,
          judgments, costs and expenses (including but not limited to reasonable
          attorney’s fees and costs), whether or not involving a third party
          claim, which arise out of your use of the Site or the Services and (1)
          any breach of any warranty, representation or acknowledgement made by
          you in this Agreement, (2) any breach or violation by you of any
          covenant or other obligation or duty under this Agreement or under
          applicable law, (3) violations by you of the laws of any jurisdiction,
          including but not limited to the state of your domicile, related to
          possession or use of marijuana, or (4) infringement of any
          intellectual property or other right of any person or entity, in each
          case whether or not caused by the negligence of any Indemnified Party
          and whether or not the relevant claim has merit.
        </p>
      </div>
      <hr />
      ...
      <div className={classes.tos__warrantyDisclaimer}>
        ...
        <p className={classes.paragraph}>
          Please note that this is a beta version of the Site and the Services
          which is still undergoing final testing before its official release.
          THE SITE AND THE SERVICES ARE PROVIDED “AS IS,” WITHOUT WARRANTIES OF
          ANY KIND. WITHOUT LIMITING THE FOREGOING, THE COMPANY EXPRESSLY
          DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS, IMPLIED OR STATUTORY,
          REGARDING THE SITE AND THE SERVICES INCLUDING WITHOUT LIMITATION ANY
          ...
          FOREGOING, THE COMPANY MAKES NO WARRANTY OR REPRESENTATION THAT ACCESS
          TO OR OPERATION OF THE SITE OR THE SERVICES WILL BE UNINTERRUPTED OR
          ERROR FREE. YOU ASSUME FULL RESPONSIBILITY AND RISK OF LOSS RESULTING
          FROM YOUR DOWNLOADING AND/OR USE OF FILES, INFORMATION, CONTENT OR
          OTHER MATERIAL OBTAINED FROM THE SITE OR THE SERVICES. SOME
      ...
      <div className={classes.tos__modifications}>
        ...
        <p className={classes.paragraph}>
          ...
          will notify you of material chances to the terms by posting a notice
          on our homepage and/or sending an email to the email address you
          provided to us upon registration. For this additional reason, you
          should keep your contact and profile information current. Any changes
          to these Terms (other than as set forth in this paragraph) or waiver
          of the Company’s rights hereunder shall not be valid or effective
          ...
          Agreement by the Company via telephonic or email communications shall
          be valid.
        </p>
      </div>
      <hr />
      ...
      <div className={classes.tos__generalTerms}>
        ...
        <p className={classes.paragraph}>
          ...
          termination of this Agreement. You agree that any cause of action
          related to or arising out of your relationship with the Company must
          commence within ONE year after the cause of action accrues. Otherwise,
          such cause of action is permanently barred. These Terms of Service and
          your use of the Site are governed by the federal laws of the United
          States of America and the laws of the State of Colorado, without
          regard to conflict of law provisions. The Company may assign or
          delegate these Terms of Service and/or the Company’s Privacy Policy,
          ...
          obligations under the Terms of Service or Privacy Policy without the
          Company’s prior written consent, and any unauthorized assignment and
          delegation by you is void. YOU ACKNOWLEDGE THAT YOU HAVE READ THESE
          ...
          TOGETHER WITH THE PRIVACY POLICY SPECIFIED ON THE PRIVACY/TOS PAGE,
