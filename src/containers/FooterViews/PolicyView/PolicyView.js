    ...
    <div className={classes.policy}>
      ...
      <div className={classes.policy__terms}>
        ...
        <p className={classes.paragraph}>
          ...
          decisions when using our Service. For purposes of this Agreement,
          “Service” refers to the Company’s service which can be accessed via
          our website at Locus.com [or through our mobile application]. in which
          users can create user accounts and create and contribute to adding
          diving information. The terms “we,” “us,” and “our” refer to the
          Company. “You” refers to you, as a user of Service. By accepting our
          Privacy Policy and Terms of Service, you consent to our collection,
      ...
      <div className={classes.policy__collect}>
        ...
        <p className={classes.paragraph}>
          ...
          Information includes only your email, which you submit to us through
          the registration process at the Site. 1. Information collected via
          Technology To activate the Service you do not need to submit any
          Personal Information other than your email address. To use the Service
          ...
          collect the following information: The Company may use both persistent
          ...
          cookies expire when you close your browser. 2. Information you provide
          us by registering for an account In addition to the information
          provided automatically by your browser when you visit the Site, to
          become a subscriber to the Service you will need to create a personal
          profile. You can create a profile by registering with the Service and
          entering your email address, and creating a user name and a password.
          By registering, you are authorizing us to collect, store and use your
      ...
      <div className={classes.policy__share}>
        ...
        <p className={classes.paragraph}>
          ...
          Policy. Otherwise, we only use the personal information, in this case
          the email address, to inform users in case of any major updates or
          issues to the service. Non-Personal Information In general, we use
          Non-Personal Information to help us improve the Service and customize
          the user experience. We also aggregate Non-Personal Information in
          order to track trends and analyze use patterns on the Site. This
          Privacy Policy does not limit in any way our use or disclosure of
          Non-Personal Information and we reserve the right to use and disclose
          such Non-Personal Information to our partners, advertisers and other
          third parties at our discretion. In the event we undergo a business
          transaction such as a merger, acquisition by another company, or sale
          of all or a portion of our assets, your Personal Information may be
          among the assets transferred. You acknowledge and consent that such
      ...
      <div className={classes.policy__update}>
        <p className={classes.paragraph}>
          Last Updated: This Privacy Policy was last updated on 01/05/2020
        </p>
      </div>
    </div>
  );
