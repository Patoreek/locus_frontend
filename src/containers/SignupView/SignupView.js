...
import { AuthDrawerHandlerContext,
         SignUpSuccessContext} from '../../context/AuthContext';
    ...
    return (
        <div className={classes.signup}>
            ...
            <div className={classes.form__certifyContainer}>
                <input 
                    type="checkbox"
                    className={`${classes.checkBox} ${password2Err ? classes.errorBorderColor : null}`} onClick={handleCheckbox} />
            ...
            <div className={classes.form__errorContainer}>
                        {errMsg.map(message => <p className={classes.errMsg}>{message}</p>)}
                    </div>    
