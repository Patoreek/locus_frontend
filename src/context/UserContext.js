...
export const UserProvider = (props) => {
    ...
    return (
        ...
        <DiveShopAdminContext.Provider value ={ [diveShopAdmin, setDiveShopAdmin]}>
        <AddDiveShopModalContext.Provider value ={ [addDiveShopModal, setAddDiveShopModal]}>
        <EditDiveShopModalContext.Provider value ={ [editDiveShopModal, setEditDiveShopModal]}>
        <DeleteDiveShopModalContext.Provider value ={ [deleteDiveShopModal, setDeleteDiveShopModal]}>
